...
class _HomeScreenState extends State<HomeScreen> {
  int _currentIndex = 2; // Default active tab set to Home
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Hide AppBar automatically when viewing the Profile Screen (Index 4)
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildActionPill('Active Booking & Receipts', onTap: () {}),
                    const SizedBox(height: 12),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Max Distance from School: ${tempMaxDistance.toStringAsFixed(1)} km',
                      style: const TextStyle(
                        fontWeight: FontWeight.w600,
                        fontSize: 16,
                      ),
